...
from database import DB_NAME, get_user, update_balance
        ...
        try:
            async with aiosqlite.connect(DB_NAME) as db:
                ...
                async with db.execute(
                    ...
                    tournament_count = (await cursor.fetchone())[0]
            ...
            if "locked" in str(e) and attempt < 2:
                ...
                print(f"Ошибка БД в check_achievements: {e}")
                return
        except Exception as e:
            print(f"Неизвестная ошибка в check_achievements: {e}")
            return